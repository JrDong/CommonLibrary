...
public class CircleView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        //设置画笔颜色
        backCirclePaint.setColor(getResources().getColor(R.color.background));
        //设置空心边框的宽度
...
//        backCirclePaint.setMaskFilter(new BlurMaskFilter(20, BlurMaskFilter.Blur.OUTER));
        ...
        lineCirclePaint.setColor(getResources().getColor(R.color.background));
        lineCirclePaint.setStrokeWidth(2);

        //刻度线
        linePaint = new Paint();
        linePaint.setAntiAlias(true);
        linePaint.setColor(getResources().getColor(R.color.trans_light_grey));
...
//        bottomPaint.setTextAlign(Paint.Align.CENTER);
    ...
    private void initTypeArray(Context context, AttributeSet attrs) {
        ...
        backCircleColor = typedArray.getColor
                (R.styleable.CircleView_backCircleColor, getResources().getColor(R.color.trans_light_grey));
        TopTextColor = typedArray.getColor(R.styleable.CircleView_TopTextColor, getResources().getColor(R.color.trans_black));
        stepTextColor = typedArray.getColor(R.styleable.CircleView_stepTextColor, getResources().getColor(R.color.trans_black));
        targetTextColor = typedArray.getColor(R.styleable.CircleView_targetTextColor, getResources().getColor(R.color.trans_black));
